    ...
    return [
        {
            ...
            "source": doc.metadata.get("source_file", doc.metadata.get("source", "Aryma Labs Repository"))  # type: ignore[attr-defined]
...
def chat(request: ChatRequest) -> ChatResponse:
    ...
    {
      "query": "your question",
      "k": 30          # optional, number of documents to retrieve
    }
    """
